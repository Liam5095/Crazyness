...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("metal_detector_from_jungle_temples", new AddItemModifier(new LootItemCondition[] {
                ...
                LootItemRandomChanceCondition.randomChance(0.42f).build() }, ModItems.METAL_DETECTOR.get()));
        ...
        add("sapphire_from_zombie", new AddItemModifier(new LootItemCondition[] {
                ...
                ,LootItemRandomChanceCondition.randomChance(0.20f).build()}, ModItems.SAPPHIRE_BOOTS.get()));

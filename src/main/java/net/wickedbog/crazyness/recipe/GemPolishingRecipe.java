package net.wickedbog.crazyness.recipe;
...
public class GemPolishingRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<GemPolishingRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(crazyness.MOD_ID, "gem_polishing");
        ...
        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, GemPolishingRecipe pRecipe) {

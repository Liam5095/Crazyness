...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(crazyness.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(crazyness.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.crazyness.gem_polishing_station");
    }
